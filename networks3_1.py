...
def resNeXt50_32x4d(pretrained=False,  num_classes=1000):
    return ResNeXt([3, 4, 6, 3], 32, 4, num_classes)

def resNeXt101_32x4d(pretrained=False,  num_classes=1000):
    return ResNeXt([3, 4, 23, 3], 32, 4, num_classes)

def resNeXt101_64x4d(pretrained=False,  num_classes=1000):
