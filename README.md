...
You can download the pre-trained model of DAGNet here: https://drive.google.com/file/d/1xYheAZIDRUOQ6xEBq4sB67snXouaw7w0/view?usp=sharing. After downloading, please place the pre trained model in the same path as networks2_2.py.
